...
# even though it doesn't look like it, you need to make this connection, the pubsub messages are a side effect of the interface
...
#need to make the application stay on